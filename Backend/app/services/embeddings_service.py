...
from app.services.gemini_service import _build_client
...
def generate_document_embeddings_json(text: str, existing_embeddings_json: str = None) -> str:
    ...
    if chunks_to_embed:
        ...
        result = client.models.embed_content(model=embeddings_model, contents=chunks_to_embed)
        new_vectors = [emb.values for emb in result.embeddings]
...
def generate_query_embedding(query: str) -> list[float]:
    ...
    embeddings_model = get_embeddings_model()
    client = _build_client()
    result = client.models.embed_content(model=embeddings_model, contents=query)
